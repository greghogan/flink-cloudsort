...
// from org.apache.hadoop.examples.terasort
...
public class GenSort {
	 ...
	 * PennySort.
	 */
	public static void generateRecord(byte[] recBuf, Unsigned16 rand, Unsigned16 recordNumber) {
	...
	public static void outputRecords(OutputStream out, boolean useAscii, Unsigned16 firstRecordNumber, Unsigned16 recordsToGenerate, Unsigned16 checksum)
			 throws IOException {
